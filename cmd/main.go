...
func main() {
	...
	engine.POST("/todo", todoHandler.HandleTodoCreate)
	engine.GET("/todo", todoHandler.HandleTodoGet)
	engine.POST("/todo/:id", todoHandler.HandleTodoUpdate)
	engine.DELETE("/todo/:id", todoHandler.HandleTodoDelete)
